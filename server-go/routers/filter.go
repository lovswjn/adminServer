...
func init() {
	...
	//库存
	//beego.InsertFilter("/stock/recordstock", beego.BeforeRouter, base.FilterPermission("stock-view"))
	//beego.InsertFilter("/stock/addStock", beego.BeforeRouter, base.FilterPermission("stock-add"))
